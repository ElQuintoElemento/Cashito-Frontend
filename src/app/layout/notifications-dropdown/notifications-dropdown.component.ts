  ...
  template: `
    <app-dropdown-menu #dropdown [isOpen]="isOpen" menuClass="w-80">
      ...
      <div class="flex items-center justify-between px-3 py-2">
        ...
        <button class="text-xs font-medium text-primary hover:text-primary/80 transition-colors" (click)="markAllAsRead()">
          Mark all as read
        </button>
      </div>
  ...
  notifications: Notification[] = [
    {
      ...
      message: 'Carlos Rivera paid installment #3 for Toyota Corolla.',
      time: '2 minutes ago',
      read: false,
      icon: 'dollar-sign',
    ...
    },
    {
      ...
      message: 'Honda Civic 2024 has been added to the catalog.',
      time: '1 hour ago',
      read: false,
      icon: 'car',
    ...
    },
    {
      ...
      message: 'Maria Garcia ran a credit simulation for $15,000.',
      time: '3 hours ago',
      read: true,
      icon: 'calculator',
